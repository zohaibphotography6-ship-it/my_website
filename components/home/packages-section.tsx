...
const collections = [
  {
    ...
    features: [
      ...
      'Couple album of 50+ images',
      'Outdoor portrait session',
      'Family album of 120+ images',
      'unlimited soft copies of all images & films',
      'full event coverage'
    ],
  },
  {
    ...
    investment: 'From 160K',
    featured: true,
    features: [
      '2 Photographers & 2 Cinematographers',
      'Drone & 360° coverage',
      'Couple album of 50+ images',
      'Family & friends album of 120+ images',
      'Highlights film (10–15 minutes)',
      'Outdoor portrait session',
      'Unlimited soft copies of all images & films',
      'full event coverage with no time restrictions'
    ],
  },
  {
    name: 'Basic Package',
